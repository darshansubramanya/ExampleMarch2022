...
public class AdvanceOne {
	...
	public static ActiTimePageAdvanceOne oPage1 = null;
...
//		minimizeFlyoutWindowUser2();
	...
	private static void launchBrowser()
	{
		try
		{
			...
			oPage1 = new ActiTimePageAdvanceOne(oBrowser);
	...
	private static void modifyUser1User2User3()
	{
		try 
		{
			...
			Thread.sleep(2000);
			oPage1.getUserPassword().sendKeys("password11");
			Thread.sleep(2000);
			oPage1.getRetypePassword().sendKeys("password11");
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			oPage1.getUserPassword().sendKeys("password22");
			Thread.sleep(2000);
			oPage1.getRetypePassword().sendKeys("password22");
			Thread.sleep(2000);
			oPage1.getSaveChangesUser().click();
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			oPage1.getUserPassword().sendKeys("password33");
			Thread.sleep(2000);
			oPage1.getRetypePassword().sendKeys("password33");
			Thread.sleep(2000);
			oPage1.getSaveChangesUser().click();
			Thread.sleep(2000);
