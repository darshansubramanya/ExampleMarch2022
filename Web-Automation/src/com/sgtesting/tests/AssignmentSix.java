...
public class AssignmentSix
{
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys("Developing The required Applications For The Customer");
			Thread.sleep(2000);
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("Health Application Development");
			Thread.sleep(2000);
